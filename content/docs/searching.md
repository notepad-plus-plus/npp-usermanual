...
However, multiple findings of the same search term may be collapsed into one search result by checking the option **Settings > Preferences > Searching > ☐ Search Result window: show only one entry per found line**.
